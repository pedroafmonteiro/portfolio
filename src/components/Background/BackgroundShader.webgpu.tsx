 ...
 * WebGPU · React component (TypeScript) · dither
 *
 * import { BackgroundShader } from "./BackgroundShader.webgpu.tsx";
 *
 * <BackgroundShader theme="dark" style={{ width: 480, height: 300 }} />
 *
 * Install @webgpu/types and add "@webgpu/types" to tsconfig compilerOptions.types.
 *
...
const WARP_AMP_Y: f32 = 0.0268541649;
const ASPECT_X: f32 = 1.89673007;
const ASPECT_Y: f32 = 0.155827969;
const OFFSET_X: f32 = 0.331398338;
const OFFSET_Y: f32 = 0.0321709551;
const TILT: f32 = -2.48987913;
...
const BREATH_RATE: f32 = 0.625468791;
const BREATH_AMOUNT: f32 = 0.0802786127;
const PHASE: f32 = 38.8217659;
const ECHO: f32 = 0.593422294;
const ECHO_SHIFT: f32 = 0.180128902;
const SOFTNESS: f32 = 0.00146618544;
const LIGHT_SWING: f32 = 0.212947875;
...
const STRENGTH: f32 = 0.978336155;
const SCALE: f32 = 1.06762004;
const SEED: f32 = 0.715693712;
...
export function BackgroundShader(props: BackgroundShaderProps) {
  const [useWebGL, setUseWebGL] = useState(() => !hasWebGPUSupport());

  if (useWebGL) {
    return <WebGLBackgroundShader key="webgl" {...props} />;
  }
